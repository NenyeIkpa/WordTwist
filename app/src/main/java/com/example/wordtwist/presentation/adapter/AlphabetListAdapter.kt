...
import com.example.wordtwist.presentation.ui.AlphabetListFragmentDirections


class AlphabetListAdapter(): RecyclerView.Adapter<AlphabetListAdapter.AlphabetViewHolder>() {
